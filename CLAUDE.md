...
| File tab: Download saves the open file to the phone through the files drawer's save dialog (the server's copy; it asks first when there are unsaved edits) | Coordinator | — | in development ("perlu tambah lagi di tab file untuk bisa download file yang lagi aktif di tab tersebut") |
