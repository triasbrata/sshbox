...
|---|---|---|---|
| Known hosts in Settings: every trusted host fingerprint listed, and one can be forgotten so the next connection asks again | Coordinator | — | in development |
...
| Host editor: Choose file reads a private key into its field (OpenSSH/PEM, 64 KB max; a public key or .ppk is refused with a hint); passphrase and password get a show/hide eye | Coordinator | 80a145e | merged, waiting for the tablet reload |
